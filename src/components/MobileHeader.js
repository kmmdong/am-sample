  ...
  render() {
    return (
      <header className={style.mHeader}>
        ...
        <Transition
            component={false}
            enter={{opacity: 2, translateY: 0}}
            leave={{opacity: 0, translateY: 5}}
        > 
          {this.props.mobileHeader.showHam &&
          <div className={style.mSubMenu} key={'subHam'}>
            ...
            <Transition
              ...
              leave={{opacity: 0, translateY: 5}}
            > 
              {this.props.mobileHeader.showAbout && <ul className= {style.mSubList} key={'subMenu1'}>
            ...
            <Transition
              ...
              leave={{opacity: 0, translateY: 5}}
            >
              {this.props.mobileHeader.showPort && <ul className= {style.mSubList} key={'subPort2'}>
